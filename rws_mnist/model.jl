...
@gen (static) function p()
    ...
    # NOTE: we should instead use h3_n = length(h3_b), but we can't because of
    # https://github.com/probcomp/Gen.jl/issues/418
    h3_n = 10 
...
# parameter initializations based on:
# https://github.com/jbornschein/reweighted-ws/blob/e96414719d09ab4941dc77bab4cf4847acc6a8e7/learning/models/sbn.py#L94
# https://github.com/jbornschein/reweighted-ws/blob/e96414719d09ab4941dc77bab4cf4847acc6a8e7/learning/model.py#L22
# https://github.com/jbornschein/reweighted-ws/blob/e96414719d09ab4941dc77bab4cf4847acc6a8e7/learning/models/sbn.py#L94
